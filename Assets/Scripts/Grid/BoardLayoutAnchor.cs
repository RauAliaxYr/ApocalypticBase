...
public class BoardLayoutAnchor : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        // Wait a frame to ensure GridController is initialized
        StartCoroutine(ApplyAfterGridInitialized());
    }

    private System.Collections.IEnumerator ApplyAfterGridInitialized()
    {
        // Wait for GridController to be initialized
    ...
    public void Apply()
    {
        ...
        {
            Debug.LogWarning("BoardLayoutAnchor: GridController is not assigned!");
            return;
        }
        ...
        {
            Debug.LogError("BoardLayoutAnchor: Cannot apply layout - anchors are null!");
        }
    }
    
    // Public method to force apply layout from other scripts
